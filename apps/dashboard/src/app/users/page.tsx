...
export default function UsersPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const computed: UserWithStats[] = (users as Array<Record<string, unknown>>).map((u) => {
      ...
      if (!cancelled) {
        setUsersWithStats(computed);
        setErrorMsg(usersRes.error ? usersRes.error.message : null);
      }
    })();
